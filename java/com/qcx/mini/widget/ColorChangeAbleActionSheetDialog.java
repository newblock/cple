...
public class ColorChangeAbleActionSheetDialog extends BottomBaseDialog<ActionSheetDialog> {
    /**
     * ListView
     */
    ...
    public ColorChangeAbleActionSheetDialog(Context context, ArrayList<DialogMenuItem> baseItems, View animateView) {
        super(context, animateView);
        mContents.addAll(baseItems);
        init();
    }

    public ColorChangeAbleActionSheetDialog(Context context, String[] items, View animateView) {
        super(context, animateView);
    ...
    public ColorChangeAbleActionSheetDialog(Context context, BaseAdapter adapter, View animateView) {
        super(context, animateView);
        mAdapter = adapter;
        init();
    }
     ...
     */
    public ColorChangeAbleActionSheetDialog titleBgColor(int titleBgColor) {
     ...
     */
    public ColorChangeAbleActionSheetDialog title(String title) {
        mTitle = title;
        return this;
    }
     ...
     */
    public ColorChangeAbleActionSheetDialog titleHeight(float titleHeight) {
     ...
     */
    public ColorChangeAbleActionSheetDialog titleTextSize_SP(float titleTextSize_SP) {
     ...
     */
    public ColorChangeAbleActionSheetDialog titleTextColor(int titleTextColor) {
     ...
     */
    public ColorChangeAbleActionSheetDialog isTitleShow(boolean isTitleShow) {
     ...
     */
    public ColorChangeAbleActionSheetDialog lvBgColor(int lvBgColor) {
     ...
     */
    public ColorChangeAbleActionSheetDialog cornerRadius(float cornerRadius_DP) {
     ...
     */
    public ColorChangeAbleActionSheetDialog dividerColor(int dividerColor) {
     ...
     */
    public ColorChangeAbleActionSheetDialog dividerHeight(float dividerHeight_DP) {
     ...
     */
    public ColorChangeAbleActionSheetDialog itemPressColor(int itemPressColor) {
     ...
     */
    public ColorChangeAbleActionSheetDialog itemTextColor(int itemTextColor) {
     ...
     */
    public ColorChangeAbleActionSheetDialog itemTextSize(float itemTextSize_SP) {
     ...
     */
    public ColorChangeAbleActionSheetDialog itemHeight(float itemHeight_DP) {
     ...
     */
    public ColorChangeAbleActionSheetDialog layoutAnimation(LayoutAnimationController lac) {
        mLac = lac;
        return this;
    }
     ...
     */
    public ColorChangeAbleActionSheetDialog cancelText(String cancelText) {
     ...
     * cancel btn text color(取消按钮文字颜色)
     */
    public ColorChangeAbleActionSheetDialog cancelText(int cancelTextColor) {
     ...
     * cancel btn text size(取消按钮文字大小)
     */
    public ColorChangeAbleActionSheetDialog cancelTextSize(float cancelTextSize) {
