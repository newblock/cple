...
public class SwitchView extends View {
    ...
    @Override protected void onDraw(Canvas canvas) {
        ...
        paint.setColor(isOn ? 0xFF499EFF : 0xffe3e3e3);
        ...
        paint.setColor(isOn ? 0xff4A90E2 : 0xfffafafa);
        canvas.drawPath(bPath, paint);
...
//                    }
    ...
    private OnChangedListener sListener;

    public void setOnChangedListener(OnChangedListener sListener){
    ...
    private OnStateChangedListener listener = new OnStateChangedListener() {
        ...
        @Override public void toggleToOn() {
            ...
            if(sListener!=null) sListener.state(4);
        }

        @Override public void toggleToOff() {
            toggleSwitch(STATE_SWITCH_OFF);
            if(sListener!=null) sListener.state(1);
        }
    };
