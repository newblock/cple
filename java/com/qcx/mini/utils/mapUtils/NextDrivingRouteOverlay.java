 ...
 * 导航路线图层类。
 */
public class NextDrivingRouteOverlay extends RouteOverlay {
     ...
     */
    public NextDrivingRouteOverlay(Context context, AMap amap, DrivePath path,
...
//            addThroughPointMarker();
    ...
    private boolean isShowTexture=true;
